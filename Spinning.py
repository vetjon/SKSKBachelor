...
class Drone:
    def __init__(self, angle, radius):
        ...
        self.x = 0
        self.y = 0
        self.angular_speed = math.pi  # Angular speed for spinning (adjustable)
        self.frame_counter = 0  # Counter to track frames for spinning delay
